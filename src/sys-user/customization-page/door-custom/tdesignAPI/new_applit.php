			...
			<div class="">
				...
				<table class="table">
					...
					<tr>
						<td><b>Type</b></td>
						<td>
						<input id="large" onchange="changeval()"  name="type" type="text" class="form-control large input-md" />
						</td>
					</tr>
					<tr>
						<td><b>Qty</b></td>
						<td>
						<input id="xlarge"  onchange="changeval()" name="qty" type="number" value="0" class="form-control xlarge input-md" min=0 max=20 />
						</td>
					</tr>
					<!--<tr>
						<td><b>XXL</b></td>
