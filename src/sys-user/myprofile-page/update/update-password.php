                    ...
                    <div class="content-cont">
                        <form action="../../../php-database/update-user.php" method="post">
                            ...
                            <label for="psw">Password</label>
                                ...
                                <input type="password" name="u_password" id="psw" placeholder="New Password" autocomplete=off required>
                                <div>
                            ...
                            <div class="alert" id="alert">
                                <div class="alert-cont">
                                    <div class="alert-content">
                                        ...
                                        <div class="alert-btn">
                                            <button class="btn-green" name="pw-btn" type="submit">Yes</button>
                                            </form>
