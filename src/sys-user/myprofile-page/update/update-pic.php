            ...
            <section id="for-edit">
                <div class="update-cont">
                    ...
                    <div class="content-cont">
                        <form action="../../../php-database/update-user.php" method="post" enctype="multipart/form-data">
                            <div class="input">
                                <label for="img">Select Image</label>
                                <input type="text" name="unique_id" value="<?php echo $loggedin_uid; ?>" hidden>
                                <input type="file" accept="image/*" name="myfile" id="img">
                            ...
                            <div class="alert" id="alert">
                                <div class="alert-cont">
                                    <div class="alert-content">
                                        ...
                                        <h1>Are you sure?</h1>
                                        <p>Do you really want to update this profile picture?</p>
                                        <div class="alert-btn">
                                            <button class="btn-green" name="ppic-btn" type="submit">Yes</button>
                                            </form>
