...
<head>
    ...
    <title>Login - Gil Reyes FRS</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            <a class="a" href="" style="border-bottom: 3px solid white; padding-bottom: 5px;">Login</a>
            <a class="a" href="../signup-page/signup-page.php">Signup</a>
        </nav>
    </header>
    <div class="divider">
