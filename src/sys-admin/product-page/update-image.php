        ...
        <div class="container">
            <div class="update-cont">
                ...
                <div class="content-cont">
                    <form action="../../php-database/update-product.php" method="post" enctype="multipart/form-data">
                        <div class="input">
                            <label for="img">Description</label>
                            <input type="text" name="uid" value="<?php echo $loggedin_uid; ?>" hidden>
                            <input type="text" name="id" value="<?php echo $id; ?>" hidden>
                            <input type="file" accept="image/*" name="product_img" id="img">
                            <input type="submit" name="prodImg-btn" value="Update">
                        </div>
                    </form>
                </div>
            </div>
